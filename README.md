...
| Deep Research / RAG Agents | [DeerFlow](https://github.com/bytedance/deer-flow), [LlamaIndex](https://docs.llamaindex.ai/), [super-rag](https://github.com/superagent-ai/super-rag) | 搜索、抓取、检索、rerank、引用、报告生成。 |
